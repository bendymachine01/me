...
def nacimiento():
    ...
    frame_nacimiento.config(bg="yellow",width=600, height=500)
...
frame1.config(bg="black",width=780, height=230)
frame1.place(x=10,y=20)

frame2 = Frame(ventana)
frame2.config(bg="black", width=780, height=230)
frame2.place(x=10,y=200)

frame3 = Frame(ventana)
frame3.config(bg="black", width=780, height=2)
frame3.place(x=10,y=500)


img = PhotoImage(file="img/yo (2).gif")
img = Button(frame2,image=img, width=200, height=220, command= img)
img.place(x=550,y=7)


bt_nacimiento = Button(ventana,text="nacimiento", command=nacimiento)    
bt_nacimiento.place(x=20, y=460, width=100, height=20)

bt_familia = Button(ventana,text="familia", command=familia)    
bt_familia.place(x=130, y=460, width=100, height=20)

bt_educacion = Button(ventana, text="educacion", command= educacion)
bt_educacion.place(x=240, y=460, width=100, height=20)

bt_amigos = Button(ventana, text="amigos", command=amigos)
bt_amigos.place(x=350, y=460, width=100, height=20)

bt_hobbies = Button(ventana,text="hobbies", command=hobbies)    
bt_hobbies.place(x=460, y=460, width=100, height=20)

bt_horario= Button(ventana,text="horario", command=horario)    
bt_horario.place(x=570, y=460, width=100, height=20)

bt_preparacion = Button(ventana, text="preparacion", command= preparacion)
bt_preparacion.place(x=680, y=460, width=100, height=20)

bt_proyecto = Button(ventana, text="proyecto", command=proyecto)
bt_proyecto.place(x=240, y=500, width=100, height=20)

bt_salud = Button(ventana, text="salud", command=salud)
bt_salud.place(x=350, y=500, width=100, height=20)

bt_libre = Button(ventana, text="libre", command=libre)
bt_libre.place(x=460, y=500, width=100, height=20)
